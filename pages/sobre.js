...
export default function Sobre() {
  return (
	...
	<div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
      ...
      <div className="place-items-left before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700/10 after:dark:from-sky-900 after:dark:via-[#0141ff]/40 before:lg:h-[360px]">
	<h2 className="h2-pages">Sobre Quero Denunciar</h2>	
	<p className="p-pages">A Quero Denunciar não possui vinculo com órgãos ou empresas. É um sistema autonomo para registros de denúncias<br /> em âmbito nacional, sem nenhum patrocinador. O objetivo do sistema é facilitar as denúncias para todo o país.</p>
      </div>
	...
	<h2 className={`${inter.className} mb-3 text-2xl font-semibold`}>
     ...
     <a
          href="/sobre"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-blue-300 hover:bg-blue-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800 hover:dark:bg-opacity-30 lg:bg-blue-100"
          rel="noopener noreferrer"
        >
          <h2 className={`${inter.className} mb-3 text-2xl font-semibold`}>
            Sobre{' '}
