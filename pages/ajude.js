...
export default function Ajude() {
  return (
	...
	<h2 className="h2-pages">Ajude a manter</h2>
	<p className="p-pages">As doações são utilizadas para novos recursos e infraestrutura Cloud do sistema. Cada centavo ajuda continuar o projeto Quero Denunciar.</p>
	<Image className="ajude-img"
		src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Logo%E2%80%94pix_powered_by_Banco_Central_%28Brazil%2C_2020%29.svg/1024px-Logo%E2%80%94pix_powered_by_Banco_Central_%28Brazil%2C_2020%29.svg.png"
		alt="Ajude a manter o projeto"
		title="Ajude a manter o projeto"
		width="175"
		height="50"
		priority  
	/>
<br />
	<strong>Chave Pix: cea4b70c-47dd-40ba-93fe-e7cb237acadf</strong>
      </div>
