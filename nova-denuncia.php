      ...
      <div class="modal-body py-0">
        ...
        <form action="salvar.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="municipio" name="municipio" aria-describedby="municipio">
            </div>
            <div class="mb-3">
                <label for="pessoas" class="form-label">Pessoas envolvidas</label>
                <input type="text" class="form-control" id="pessoas" name="pessoas" aria-describedby="pessoas">
            </div>
            <div class="mb-3">
                <label for="testemunhas" class="form-label">Testemunhas</label>
                <input type="text" class="form-control" id="testemunhas" name="testemunhas" aria-describedby="testemunhas">
            </div>
            <div class="mb-3">
